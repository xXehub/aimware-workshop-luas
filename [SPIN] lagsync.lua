...
lagsyncbox = gui.Combobox(groupboxlag,"lagsync_type","Lagsync Type","Off","CT Auto","Lagsync V1","Lagsync V2","Lagsync V3","Lagsync V4","Lagsync V5","Custom");
    ...
    if cmd.tick_count % delayamount:GetValue() == 0 then
        ...
        if lagsyncbox:GetValue() == 1 then
            ...
            elseif lagsyncbox:GetValue() == 6 then
                ...
                if switch then
                    yawamount:SetValue(5);
                    fakeamount:SetValue(48);
                else
                    yawamount:SetValue(10);
                    fakeamount:SetValue(46);
                end
            
            elseif lagsyncbox:GetValue() == 7 then
                if switch then
