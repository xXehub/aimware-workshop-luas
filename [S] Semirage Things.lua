...
local baim = 1;
 ...
 ------------------------------------------------ Window 
local Window = gui.Window( "semirageWindow", "Semirage Helper 1.1 by -_UnknownPerson_-#6472", 150, 150, 530, 700  )
...
local GROUPBOX_AIMBOT=gui.Groupbox(Window, "Aimbot Things", 320, 380, 200)
...
function indicatorsMala()
    ...
    if CHECKBOX_ALL:GetValue() then 
        if (baim%2 == 0) then
            draw.Color(151,236,247,255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 20, "BAIM")
        elseif (baim%2 == 1) then
            draw.Color(166, 36, 73, 255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 20, "BAIM")
        end
    end
    ...
    if CHECKBOX_ALL:GetValue() then 
        if awtggl then
            draw.Color(151,236,247,255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 40, "AWALL")
        else
            draw.Color(166, 36, 73, 255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 40, "AWALL")
        end
    ...
    if CHECKBOX_ALL:GetValue() then 
        if (gui.GetValue( "rbot.accuracy.posadj.resolver")) then 
            draw.Color(151,236,247,255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 60, "RESOLVER")
        else
            draw.Color(166, 36, 73, 255)
            draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 60, "RESOLVER")
        end 
    ...
    if CHECKBOX_ALL:GetValue() then
        ...
        draw.Color(151,236,247,255)
        draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 100, "FOV: ")
...
if CHECKBOX_ALL:GetValue() then --legit / rage indicator
    ...
    if switchB then 
       ...
       draw.Color(100,100,255,255)
        draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 120, "LEGIT")
    else
        draw.Color(100,100,255,255)
        draw.TextShadow(IndX:GetValue(), IndY:GetValue() - 120, "RAGE")
    end
